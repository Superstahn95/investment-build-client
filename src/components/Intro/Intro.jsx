      ...
      <div className="grid md:grid-cols-2 gap-8 mx-auto p-4 w-full md:w-[80%]">
        ...
        <div>
          <h2 className="font-bold text-slate-900 text-lg text-center md:text-xl 2xl:text-4xl mb-7">
            About Blackrockminefx.com
          </h2>
          <p className="mb-5">
            blackrockminefx.com is an investment company offering
            ...
            individual, group, and institutional investors. blackrockminefx.com
            is licensed to trade digital assets to clients in over 147 countries
            around the world. Our offered assets bring high returns for our
            clients, who have trusted us for over 6 years now.
          </p>
          <p className="mb-5">
