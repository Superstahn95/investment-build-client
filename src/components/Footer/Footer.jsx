  ...
  return (
    <footer className="bg-slate-800 min-h-[40vh] flex flex-col items-center font-montserrat">
      <p className="text-white text-lg md:text-2xl font-bold mt-10 mb-5 text-center">
        Over 300,000 dollars has been invested with Blackrockminefx
      </p>
      <Link
        to="register"
        className="p-2 rounded-md bg-red-400 text-white font-bold w-[150px] flex items-center justify-center hover:bg-transparent border-white hover:border"
      >
        Get Started
      </Link>
      <div className="grid px-4 py-4 md:py-10 md:grid-cols-3 gap-8 border-t border-b border-white w-full  md:w-[80%] my-7">
        <div>
          ...
          <p className="text-white text-sm">
            ...
            Blackrockminefx was established with a clear vision.
          </p>
        </div>
        <div>
      ...
      <div className="my-4">
        <p className="text-white text-center text-xs md:text-lg">
          Copyright © 2023 Blackrockminefx. All Rights Reserved.
        </p>
      </div>
    </footer>
  );
